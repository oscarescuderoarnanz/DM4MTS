...
def numberofpatientsrepeat(df_bin):
    ...
    while (not(df_aux.empty)):
        ...
        if aux.shape[0] > 1:
            ...
            #print("\nVector de características repetido número", i, ":")
            i = i + 1
    ...
    print("\t Number of repeated non-MDR patients (of the same class)", countnoMR)
    print("\t Number of repeated MDR patients (of the same class)", countMR)
