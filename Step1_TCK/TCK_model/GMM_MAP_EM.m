...
p.addParameter('minT', 3, @(z) assert(z>=1 && z<=T, 'The minimum length of time segments should be in [1,T]'));
p.addParameter('maxT', 4, @(z) assert(z>=1 && z<=T, 'The maximum length of time segments should be in [1,T]'));
p.addParameter('C', 40);
